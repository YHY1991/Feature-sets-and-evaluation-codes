function [accu, result] = test_fs_accu_San_Francisco(feature_set, Dataset, classifier_type)
    ...
    switch(classifier_type)
        case 'SVM'
            ...
            model = libsvmtrain(train_labels, fs_train_X, Dataset.svm_para); 
            [predict_labels, corrected_num, ~] = libsvmpredict(test_labels, fs_test_X, model, '-q');
        ...
        case 'KNN'
            mdl = fitcknn(fs_train_X, train_labels,'NumNeighbors',8, 'Distance','euclidean');
