function [Dataset] = get_data_S1AFS(dataset_name)
    % load data
    disp(['Load ' char(dataset_name) ' dataset...'])
    load('.\data\S1AFS_all_metrics_normalized.mat');
    A = all_metrics_normalized;
    A(find(isnan(A)==1)) = 0;
    load('.\data\S1AFS_GT.mat');
    ground_truth = S1AFS;
    ...
    Dataset.A = A; %[1240 ¡Á 1240 ¡Á 126  double]
    Dataset.ground_truth = ground_truth; %[1240 ¡Á 1240 ¡Á 126 double]
end